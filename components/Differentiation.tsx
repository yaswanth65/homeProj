...
const Differentiation: React.FC = () => {
  ...
  return (
    <section id="why-haven" className="py-24 bg-white">
      <div className="max-w-[90%] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            ...
            >
              <h2 className="text-xs text-secondary uppercase tracking-[-0.08em] tracking-widest mb-4">
                Why Luxe Haven Realty
              </h2>
              <p className="text-3xl md:text-4xl tracking-[-0.08em] font-normal text-primary leading-tight mb-12">
